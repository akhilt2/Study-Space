          ...
          <div className="w-full max-w-md flex flex-col items-center">
            ...
            {platformUrl ? (
              ...
              >
                ...
                <span className="font-semibold tracking-tight text-black/50 group-hover:text-black/70">Study Space</span>
              </a>
            ) : (
              <div className="mt-10 flex items-center gap-1.5 text-[11px] text-black/30">
                <span>{t('common.powered_by', { defaultValue: 'Powered by' })}</span>
                <span className="font-semibold tracking-tight text-black/50">Study Space</span>
              </div>
            )}
