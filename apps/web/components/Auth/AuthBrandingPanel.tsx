...
export default function AuthBrandingPanel({ org, welcomeText, title, subtitle }: AuthBrandingPanelProps) {
  ...
  const UNSPLASH_UTM = '?utm_source=StudySpace&utm_medium=referral'
  ...
  const noOrgTitle = title || 'Welcome back to Study Space.'
  const noOrgSubtitle =
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className={cn(
                  ...
                  <div className="space-y-1">
                    <h1 className="font-black text-3xl tracking-tight">{org?.name || 'Study Space'}</h1>
                    {displayMessage && (
                      <p className={cn(
